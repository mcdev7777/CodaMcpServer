...
exports.registerUpsertCodaRowsTool = registerUpsertCodaRowsTool;
 ...
 */
function registerUpsertCodaRowsTool(server) {
    /**
     ...
     */
    server.tool("upsert-coda-rows", {
        docId: zod_1.z.string(),
        tableId: zod_1.z.string(),
        rows: zod_1.z.array(zod_1.z.record(zod_1.z.any())),
        keyColumns: zod_1.z.string().optional()
